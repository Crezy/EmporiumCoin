...
const string strMessageMagic = "EmporiumCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 6400000 * COIN; return nSubsidy; 
	}
	...
	else if(pindexBest->nHeight < 25001)
	{
        nSubsidy = 2100 * COIN;
    }
	else if(pindexBest->nHeight < 30001)
	{
        nSubsidy = 1800 * COIN;
    }
	else if(pindexBest->nHeight < 35001)
	{
        nSubsidy = 1500 * COIN;
    }
	else if(pindexBest->nHeight < 40001)
	{
        nSubsidy = 1200 * COIN;
    }
	else if(pindexBest->nHeight < 45001)
	{
        nSubsidy = 900 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EmporiumCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Genesis of EMPORIUMCOIN";
        CTransaction txNew;
        txNew.nTime = 1463700297;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1463700297;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1209773 ;
		if(fTestNet)
        {
            block.nNonce = 1209773 ;
        }
		
		uint256 nhashMerkleRoot = uint256("1964a302a71cdeaa557952efa477e450d61993658fe37e59b71bc80ceff01594");
...
unsigned char pchMessageStart[4] = { 0xc2, 0xb4, 0xa3, 0xd1 };
